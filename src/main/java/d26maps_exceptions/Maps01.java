...
public class Maps01 {
    public static void main(String[] args) {
        ...
        System.out.println(stdAges);//{null=39, Ahmet=41, a=null, b=null, Sefa=null, Ali=18}
        ...
        //countryPoulation.put(null,18000); HATA key null olamaz
        countryPopulation.put("Italy",null);

        System.out.println(countryPopulation);//{Germany=83000000, Italy=null, Netherland=18000000, Türkiye=83000000, USA=400000000}
