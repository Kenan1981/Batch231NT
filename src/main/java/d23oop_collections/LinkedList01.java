...
public class LinkedList01 {
    public static void main(String[] args) {
        ...
        System.out.println(myList);//[Ali, Veli, Ayşe, Fatma] insertion sırasına göre.

        //-----------------------ekstra bilgi-kısa yolla eleman ekleme
       ...
       /* LinkedList<String >linkedList=new LinkedList<>(Arrays.asList("Eleman1","Eleman2","Eleman3"));
        ...
        immutableList.add("Serkan");//  Hata verir.
        ...
        myList.addLast("Kenan");
        System.out.println(myList);             //[Hasan, Ali, Zeynep, Veli, Ayşe, Fatma, Kenan]
        //normal add te yapsak sona ekleyecekti...Okunurluk için addLast kullanılır.

        ////5) remove(Object o): Belirtilen öğeyi listeden kaldırır ve boolean dondurur
        boolean m1 = myList.remove("Ali");
        System.out.println(myList);                  //[Hasan, Zeynep, Veli, Ayşe, Fatma, Kenan]
        ...
        myList.add("Yusuf");//sona ekler
        myList.add(3, "Yusuf");
        System.out.println(myList);               //[Hasan, Zeynep, Veli, Yusuf, Ayşe, Fatma, Kenan, Yusuf]

        myList.removeFirstOccurrence("Yusuf");
        System.out.println(myList);              //[Hasan, Zeynep, Veli, Ayşe, Fatma, Kenan, Yusuf]

        //---------------Ekstra bilgi
       /* myList.removeAll(Collections.singleton("Yusuf"));//Kaç tane yusuf varsa siler
        System.out.println(myList);//[Hasan, Zeynep, Veli, Ayşe, Fatma, Kenan]*/
        ...
        System.out.println(myList);   //[Hasan, Zeynep, Veli, Ayşe, Fatma, Kenan]. listeden kaldırmaz.sadece bakmak için.
        ...
        System.out.println(myList);         //[Zeynep, Veli, Ayşe, Fatma, Kenan]
        ...
        System.out.println(myList);//[Veli, Ayşe, Fatma, Kenan]
