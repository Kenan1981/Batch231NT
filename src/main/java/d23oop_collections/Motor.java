...
Bu yüzden interface'lere "to do list " de denir.(yapilacaklar listesi)
        ...
        class               	class        	==> 	 extends
        interface           	interface   	==> 	 extends   --->Bir interface başka bir interface' child olabilir
        class               	interface   	==> 	 implements
        interface           	class       	==> 	 olamaz    ---->Bir interface başka bir interface'in childı olamaz
*/
    ...
    a) Abstract class'lar hem abstract method hemde concrete(somut) methodlar icerebilir.
    ...
    int fiyat = 300;//public static final yazmaya gerek yok. default

    default void guc(){//default burada keyword.accesmodifiere public tir.
