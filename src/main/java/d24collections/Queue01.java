...
public class Queue01 {
    public static void main(String[] args) {
        ...
        depo.add("yumurta");
        depo.add("peynir");
        System.out.println(depo);//[sut, et, yumurta, peynir]-insertion order sırası
        ...
        //System.out.println(depo.clear(););  HATA. hem sil hem yaz olmaz
        depo.clear();
        ...
        //System.out.println(depo.element()); HATA-exeption
        ...
        //Deque<String>d2=new ArrayDeque<>(); ' de yazılabilir
        ...
        d.add("Oya");
        d.add("Tansu");
        System.out.println(d);//[Mehmet, Mahmut, Ekrem, Oya, Tansu] // insertion sırası
        ...
        for (String w : d) {
            System.out.println(w);   //Alt alta yazdırmak için.
        }
        System.out.println("-------------------");
