...
5- Bir veya daha fazla parametre alabilir*/
        ...
        // printElements2(nums);//12 9 131 14 9 10 4 12 15  / lambda
    ...
    //  yazdiran method'u olusturunuz.(Functional==Lmabda)
    ...
    public static void printElements2(List<Integer> nums) {
        nums.stream().forEach(t -> System.out.print(t + " "));//değişken adıdır. type dan gelir.t->, akıştan gelen her t değeri için
    }//stream yazmasak da olur.
//--------------------------------------------------------------------------------------
