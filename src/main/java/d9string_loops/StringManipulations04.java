...
public class StringManipulations04 {
    public static void main(String[] args) {
        ...
        int a = 12;
                 ...
                 */
        // ==  sadece stack taki adresi yoklar. equals ise heap taki veriye bakar
        ...
        System.out.println(str1==str3);//true   str1 in adresi str3 e atandığı için true çıkar

        String s1 = "ali";
        String s2 = "ali";
        System.out.println(s1==s2); // String pool. new kullanmadığımızdan true olur. adresler aynı..new olursa yeni adres oluşur.
