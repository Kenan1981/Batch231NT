...
public class CourseRunner {
    public static void main(String[] args) {
        //Course class'ı parametreli,constructor'unu kullanarak Object oluşturalım
        ...
        System.out.println(result5);//true, yok anlamında true verdi
        ...
        System.out.println("----------");
              ...
              /* String result8 = courseList.
                stream().sorted(Comparator.
                        comparing(Course::getAverageScore).
                        reversed()).
                        findFirst().get().
                        getCourseName();
                        System.out.println(result8);//Turkish Night*/
        String result8 = courseList.
                stream().max(Comparator.
                        comparing(Course::getAverageScore)).get().
                getCourseName();
        System.out.println(result8);//Turkish Night
        ...
        List<Course> myList = courseList.
                ...
                skip(2).
                toList();
        System.out.println(myList);//[Course{season='Summer', courseName='Turkish Day', averageScore=97, numberOfStudents=128}, Course{season='Winter', courseName='Turkish Night', averageScore=98, numberOfStudents=154}]

        //9) Tum course object'lerini average score'a gore kucukten buyuge diziniz ve
        // ilk üçünü liste halinde console'a yazdiriniz.

        //a) limit, Stream’den belirli sayıda eleman alır. Burda ilk 3'unu aldik
        List<Course> yourList = courseList.stream().sorted(Comparator.comparing(Course::getAverageScore)).limit(3).toList();
        System.out.println(yourList);//[Course{season='Winter', courseName='English Night', averageScore=93, numberOfStudents=144}, Course{season='Spring', courseName='English Day', averageScore=95, numberOfStudents=132}, Course{season='Summer', courseName='Turkish Day', averageScore=97, numberOfStudents=128}]
        System.out.println("---------------------------");
        ...
        //Geliştirme
        List<Integer> studentNumberSorted = courseList.
                stream().
                sorted(Comparator.
                        comparing(Course::getNumberOfStudents).
                        reversed()).
                ...
                collect(Collectors.toList());
        System.out.println(studentNumberSorted);//[154, 144, 132, 128]
        ...
        List<Course>studentNumberOf=courseList.stream().filter(t->t.getNumberOfStudents()<140).collect(Collectors.toList());
        System.out.println(studentNumberOf);//[Course{season='Summer', courseName='Turkish Day', averageScore=97, numberOfStudents=128}, Course{season='Spring', courseName='English Day', averageScore=95, numberOfStudents=132}]
