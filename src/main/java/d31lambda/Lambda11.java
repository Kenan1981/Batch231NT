...
public class Lambda11 {
    public static void main(String[] args) {
        ...
        // int sum= getSumFromSevenToSevety();
        // System.out.println(sum);//2464*/
        //int sum = getMultiplicationFromThreeToNine1();//181440
...
*/
    public static int getSumFromSevenToSevety() {
        return IntStream.
                rangeClosed(7, 70).
                reduce(Math::addExact).//Integer class'taki sum()'da kullanılabilirdi.//Math::addExact (overflow kontrolu var)yerine, Integer class'taki sum()'da kullanilabilirdi
                        getAsInt();
    }
    ...
    public static int getFactorial(int x){
        if (x==0){
            ...
            System.out.println("Negatif ten faktoriyel olmaz");
            return -1;
        }else {
