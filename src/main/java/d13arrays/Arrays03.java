...
public class Arrays03 {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.binarySearch(arr,7));//3.index te var
        System.out.println(Arrays.binarySearch(arr,3));//-3 olmadığı için -.olsaydı 3.sırada olacaktı
        System.out.println(Arrays.binarySearch(arr,9));//-5 olsaydı 5. sırada olacaktı
