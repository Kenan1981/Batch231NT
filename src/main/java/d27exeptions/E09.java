...
public class E09 {
    public static void main(String[] args) {
        ...
        3) IOException ve FileNotFoundException beraber kullanilacak ise FileNotFoundException üstte olmalidir. Parent altta olmalı
         */
        try {
            FileInputStream fis=new FileInputStream("src/main/java/d27exeptions/file.txt");
